...
# Stores Binary Code translations/equivalents for Hack assembly 
# in dictionary (as key-val pair based on field type)
class Translate:
    CODES = { 
        'dest': {
            None:  '000',
...
# Returns the binary code of the specified field type (mnemonic)
class Code:
    @staticmethod
    def dest(mnemonic):
